...
$(document).ready(function(){
	...
	var container = document.getElementById('background-anim');
	var controls = document.getElementById('background-anim-controls');
	var output = document.getElementById('background-anim-output');
	var ui = document.getElementById('page-ui');
